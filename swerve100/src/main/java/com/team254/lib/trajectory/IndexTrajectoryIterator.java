...
public class IndexTrajectoryIterator<S extends State<S>, T extends State<T>> {
    protected final IndexView<S, T> view_;
    protected double progress_ = 0.0;
    protected TrajectorySamplePoint<S, T> current_sample_;

    public IndexTrajectoryIterator(final IndexView<S, T> view) {
        view_ = view;
