...
public class Rotation2d extends edu.wpi.first.math.geometry.Rotation2d implements State<Rotation2d> {
    ...
    // public static final Rotation2d kHalfPi = new Rotation2d(Math.PI / 2.0,
    // false);
    public static final Rotation2d kHalfPi = new Rotation2d(Math.PI / 2.0);
    ...
    // return new Rotation2d(cos_angle_ * other.cos_angle_ - sin_angle_ *
    // other.sin_angle_,
    ...
    private synchronized void ensureTrigComputed() {
        // if (!hasTrig()) {
        // assert(hasRadians());
        // sin_angle_ = Math.sin(getRadians());
        // cos_angle_ = Math.cos(getRadians());
        // }
    }
