...
//   private final Rotation2d m_rotation;
  ...
  public Transform2d(edu.wpi.first.math.geometry.Translation2d translation, edu.wpi.first.math.geometry.Rotation2d rotation) {
    super(translation, rotation);
    // m_translation = translation;
    // m_rotation = rotation;
  }
...
//     return new Transform2d(getTranslation().times(scalar), getRotation().times(scalar));
//   }
